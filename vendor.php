   ...
   <div class="modal fade bd-example-modal-lg" id="Add-New-Item-Modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">New Vendor Entry Form</div>

<form method="post" action="vendorins.php" autocomplete="off">
...
<div class="modal-body">
  ...
  <input type="text" class="form-control" name="vname" size="15" required autocomplete="off">
  </div>

  <div class="form-group col-md-6">
  <label>Address</label>
  <input type="text" class="form-control" name="vaddress" size="15" autocomplete="off" required>
</div>
</div>
...
<div class="form-group col-md-6">
    ...
    <input type="text"  class="form-control" name="vcontactname" size="15" autocomplete="off" required>
  </div>

  <div class="form-group col-md-6">
    <label>Website Address</label>
    <input type="text"  class="form-control" name="vweb" size="15" autocomplete="off" required>
  </div>
  </div>
...
<div class="form-group col-md-6">
    ...
    <input type="text" class="form-control"  name="vmail" size="15" autocomplete="off" required>
  </div>

<div class="form-group col-md-6">
    <label>Phone Number</label>
    <input type="text" class="form-control"  name="vphone" size="15" autocomplete="off" required>
  </div>
</div>
