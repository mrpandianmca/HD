...
<!-- <a class="nav-link text-center" id="">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      $sql = "SELECT FILE_NAME,ITEM_NO,ITEM_NAME,ITME_DESCRIPTION,DATE_FORMAT(PUR_DATE, '%d-%m-%Y') PUR_DATE,CAMPUS,DEPARTMENT,PRICE_PER_ITEM,NO_OF_ITEM,DATE_FORMAT(WARRANTY_EXPIRE_DATE, '%d-%m-%Y') WARRANTY_EXPIRE_DATE,VENDOR from RCC_PURCHASE ORDER BY ITEM_NO ASC LIMIT $offset, $rec_limit";
    }
    else
    {
      $page = 0;
...
<div class="card mb-3">
      ...
      <?php
        ...
        $sql = "SELECT FILE_NAME,ITEM_NO,ITEM_NAME,ITME_DESCRIPTION,DATE_FORMAT(PUR_DATE, '%d-%m-%Y') PUR_DATE,CAMPUS,DEPARTMENT,PRICE_PER_ITEM,NO_OF_ITEM,DATE_FORMAT(WARRANTY_EXPIRE_DATE, '%d-%m-%Y') WARRANTY_EXPIRE_DATE,VENDOR from RCC_PURCHASE  ORDER BY ITEM_NO";//   LIMIT $offset, $rec_limit";
        }      
      ?>

          <a data-toggle="modal" data-target="#Add-New-Item-Modal"><button class="btn btn-primary float-right">Add New Product</button></a></div>
...
require_once 'config.php';
$v_max_no=0;
$sql = mysqli_query($link, "SELECT MAX(ITEM_NO) MAX_NO FROM `rcc_purchase`");
$row = mysqli_num_rows($sql);
while ($row = mysqli_fetch_array($sql)){
$v_max_no=$row['MAX_NO']+1;
}
echo "<input type='text' class='form-control' value=' $v_max_no ' name='itemno' size='15' placeholder='Enter Item No' autocomplete='off' required>"
?>
  ...
  <input type="text" class="form-control" name="itemname" size="15" placeholder="Enter Item Name" autocomplete="off" required>
</div> -->
<div class="form-group col-md-6">
    <label>Item Name</label>
    <!--input type="text" class="form-control"  name="itemname" size="15" placeholder="Enter Item Name" required-->
    <select name="itemname" class="form-control" style="text-transform: uppercase;">
...
<div class="form-group col-md-6">
    ...
    <input type="text"  class="form-control" name="itemdesc" size="15" placeholder="Enter Item Description" autocomplete="off" required>
  </div>

  <!-- <div class="form-group col-md-6">
    <label>PO Date</label>
    <input type="text"  class="form-control" name="podate" size="15" placeholder="Enter Purchase Order Date" autocomplete="off" required>
  </div>
  </div> -->
  ...
  <input class="form-control" size="16" name="podate" type="text" placeholder="Enter Purchase Order Date" autocomplete="off" value="" readonly>
...
<!-- <div class="form-group col-md-6">
    <label>Campus</label>
    <input type="text" class="form-control"  name="campus" size="15" placeholder="Enter Campus Details" autocomplete="off" required>
  </div> -->
  <div class="form-group col-md-6">
    <label>Item Name</label>
    <!--input type="text" class="form-control"  name="campus" size="15" placeholder="Enter Item Name" required-->
    <select name="campus" class="form-control" style="text-transform: uppercase;">
    <option value="">--Select--</option>
<?php
require_once 'config.php';
$sql = mysqli_query($link, "SELECT CAMPUS_NAME FROM CAMPUS");
$row = mysqli_num_rows($sql);
while ($row = mysqli_fetch_array($sql)){
...
<div class="form-group col-md-6">
    ...
    <input type="text" class="form-control"  name="dept" size="15" placeholder="Enter Department Details" autocomplete="off" required>
  </div>
</div>
...
<div class="form-group col-md-6">
    ...
    <input type="text" class="form-control"  name="povalue" size="15" placeholder="Enter Purchase Order Value" autocomplete="off" required>
  </div>

<div class="form-group col-md-6">
    <label>Quantity of Item</label>
    <input type="text" class="form-control"  name="quantityitem" size="15" placeholder="Enter Quantity of Item" autocomplete="off" required>
  </div>
</div>
...
<!-- <div class="form-group col-md-6">
    ...
    <input type="text" class="form-control"  name="warrantydate" size="15" placeholder="Enter Warranty Expire Date" autocomplete="off" required>
  </div> -->
  <div class="form-group col-md-6">
  <label>Warranty Expiry Date</label>
  <div class="controls input-append date form_date" data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input1" data-link-format="yyyy-mm-dd">
  <input class="form-control" size="16" name="warrantydate" type="text" placeholder="Enter Warranty Expire Date" autocomplete="off" value="" readonly>
  <span class="add-on"><i class="icon-remove"></i></span>
	<span class="add-on"><i class="icon-th"></i></span>
  </div>
	<input type="hidden" id="dtp_input1" value="" /><br/>
