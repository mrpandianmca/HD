...
<div class="card mb-3">
      ...
      ?>
          ...
          <a data-toggle="modal" data-target="#Add-New-Item-Modal"><button class="btn btn-primary float-right">Add New PO Item</button></a></div>
...
<div class="form-group col-md-4">
    ...
    <input type="text" class="form-control"  name="itemmake" size="15" placeholder="" autocomplete="off" required>

    <label>AMC</label>
    <input type="text" class="form-control"  name="amc" size="15" placeholder="" autocomplete="off" required>
  </div>

<div class="form-group col-md-8">
    <label>Item Description</label>
    <!-- <input type="text"  class="form-control" name="itemdesc" size="15" placeholder="Enter Item Description" autocomplete="off" required> -->
    <textarea class="form-control" rows="5" name="itemdesc"></textarea> 
  </div>
  </div>
  <!-- <div class="form-group col-md-6">
    <label>PO Date</label>
...
<div class="form-group col-md-4">
    <label>Vendor-II</label>
    <!--input type="text" class="form-control"  name="vendor" size="15" placeholder="Enter Vendor Details" required-->
    <select name="vendor2" class="form-control" style="text-transform: uppercase;">
    <option value="">Select</option>
<?php
require_once 'config.php';
$sql = mysqli_query($link, "SELECT VENDOR_NAME FROM VENDOR");
...
?>
  ...
  <div class="form-group col-md-4">
    <label>Vendor-III</label>
    <!--input type="text" class="form-control"  name="vendor" size="15" placeholder="Enter Vendor Details" required-->
    <select name="vendor3" class="form-control" style="text-transform: uppercase;">
    <option value="">Select</option>
<?php
require_once 'config.php';
$sql = mysqli_query($link, "SELECT VENDOR_NAME FROM VENDOR");
